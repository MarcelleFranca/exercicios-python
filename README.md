...
01) 'Olá,Mundo!' - Deixando tudo pronto para elaboração dos exercicios.
...
21) Faça um programa em Python que abra e reproduza o áudio de um arquivo MP3. ***ESSE NÃO FOI POSSÍVEL ELABORAR PELAS DIVERGENCIAS DE MUDANÇAS DE INTERPRETADOR***
...
65) rie um programa que leia vários números inteiros pelo teclado. No final da execução, mostre a média entre todos os valores e qual foi o maior e o menor valores lidos. O programa deve perguntar ao usuário se ele quer ou não continuar a digitar valores.
